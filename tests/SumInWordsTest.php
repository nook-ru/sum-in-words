...
test('sumInWords без копеек', function ($sum, $result, $roundSum = true) {
	...
	['1234567891234567890', 'один квинтиллион двести тридцать четыре квадриллиона пятьсот шестьдесят семь триллионов восемьсот девяносто один миллиард двести тридцать четыре миллиона пятьсот шестьдесят семь тысяч восемьсот девяносто рублей'],
]);
